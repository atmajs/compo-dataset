...
(function (root, factory) {
   ...
   */
	...
	var PagerDataProvider = Compo({
		...
		slots: {
			dataPagePrev: function dataPagePrev() {
				this.go_(-1);
			},
			datePageNext: function datePageNext() {
				this.go_(1);
			}
		},
		...
		load_: function load_() {
			...
			return $.getJSON(this.xEndpoint, (function () {
				var _$$getJSON = {};

				_defineProperty(_$$getJSON, _this.xQueryPageNum, _this.model.pageNum);

				_defineProperty(_$$getJSON, _this.xQueryPageSize, _this.model.pageSize);

				return _$$getJSON;
			})()).done(function (page) {
				_this.setData_(page);
				_this.aDataset.activity(-1);
			});
		},
